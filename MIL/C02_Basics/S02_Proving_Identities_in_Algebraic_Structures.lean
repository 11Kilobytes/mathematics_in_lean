...
theorem neg_neg (a : R) : - -a = a := by
  have : a = - (-a) := eq_neg_of_add_eq_zero (add_right_neg a)
  rw [← this]
...
theorem mul_right_inv (a : G) : a * a⁻¹ = 1 := by
  calc a * a⁻¹
    ...
    _ = a⁻¹⁻¹ *  a⁻¹                    := by rw [mul_left_inv, one_mul]
...
theorem mul_one (a : G) : a * 1 = a := by
  calc a * 1
    ...
    _ = a             := by rw [← mul_assoc, mul_right_inv, one_mul]

theorem mul_inv_rev (a b : G) : (a * b)⁻¹ = b⁻¹ * a⁻¹ := by
  have : (b⁻¹ * a⁻¹)  * (a * b) = 1 := by
    calc  (b⁻¹ * a⁻¹) * (a * b)
      _ = b⁻¹ * (a⁻¹ * a * b)
          := by rw [mul_assoc, ← mul_assoc a⁻¹]
      _ = b⁻¹ * b
          := by rw [mul_left_inv, one_mul]
      _ = 1
          := by rw [mul_left_inv]
  calc (a * b)⁻¹
      _ = ((b⁻¹ * a⁻¹)  * (a * b)) * (a * b)⁻¹
          := by nth_rw 1 [← one_mul (a * b)⁻¹, ← this]
      _ = (b⁻¹ * a⁻¹)
